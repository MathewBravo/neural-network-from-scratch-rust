...
pub fn dot_prod(vec1: &[f32], vec2: &[f32]) -> Result<f32, MathError> {
...
mod tests {
    ...
    #[test]
    fn test_dot_prod_success() {
        let vec1 = vec![1.0, 2.0, 3.0];
        let vec2 = vec![4.0, 5.0, 6.0];

        let result = dot_prod(&vec1, &vec2);

        assert_eq!(result, Ok(21.0));
    }

    #[test]
    fn test_dot_prod_failure_different_lengths() {
        let vec1 = vec![1.0, 2.0, 3.0];
